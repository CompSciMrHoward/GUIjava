...
public class AListenerLesson implements ActionListener {
	JButton b1, b2, b3;

	public static void main(String[] args) {
		AListenerLesson window = new AListenerLesson("1", "2", "3");
	}

	
	public AListenerLesson(String text1, String text2, String text3) {
